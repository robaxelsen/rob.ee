    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col sm:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:rob@rob.ee" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://www.youtube.com/channel/UCUI8a3ZsO4CEwsZyWVKXrFA" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/robaxelsen" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://twitter.com/robaxelsen" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://www.instagram.com/robaxelsen/" target="_blank" class="text-white hover:text-gray-400">
